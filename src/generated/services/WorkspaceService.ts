...
/* tslint:disable */
/* eslint-disable */
import type { WorkspaceCollectionModel } from '../models/WorkspaceCollectionModel';
...
export class WorkspaceService {
     ...
     * + project_phase_[id]: a filter on a project phase active in a workspace. The id is the id of the phase queried for.
     ...
     * @returns WorkspaceCollectionModel OK
     * @throws ApiError
     */
    public listWorkspace(
        ...
        sortBy?: string,
        select?: string,
    ): CancelablePromise<WorkspaceCollectionModel> {
